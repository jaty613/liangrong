...
var webpackConfig = merge(baseWebpackConfig, {
  // module: {
  //    loaders: utils.styleLoaders({ sourceMap: config.build.productionSourceMap, extract: true }) //  大坑
  // },
  ...
  plugins: [
    ...
    // extract css into its others file
    ...
    // split vendor js into its others file
    ...
    // extract webpack runtime and module manifest to its others file in order to
