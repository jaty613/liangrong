...
<script type='text/babel'>
  ...
  export default {
    ...
    vuex: {
      getters: {
        RS28501: state => state.all['28501:0']
      },
      actions: {
        AS28501: $AS('28501:0'),
        RL28501: $RELOAD('28501:0:0:4'),
        search: $AS('28501:0:SEARCH')
      }
    },
    methods: {
      loadMore () {
        $P('28501:0').position_str = this.RS28501[this.RS28501.length - 1].position_str
        if (!this.reload) {
