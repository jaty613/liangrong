          ...
          <li>
            <div class="am-flexbox ">
              ...
              <div class="am-flexbox-input ui-form-field">
                <input v-model="params.account_content" readonly type="text" class="text_input " placeholder="手机号码/资金账号">
              </div>
  ...
  export default {
    ...
    route: {
      data: function (transition) {
        this.params.account_content = window.getUrlParamVal('fund_account')
      }
    },
    ready: function () {
